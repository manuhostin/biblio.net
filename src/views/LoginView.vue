...
.form-group {
  margin-bottom: 20px;
  /* Espaço abaixo de cada grupo */
}

/* Estiliza o rótulo */
.form-group label {
  display: block;
  /* Faz o rótulo ocupar toda a largura disponível */
  margin-bottom: 8px;
  /* Espaço abaixo do rótulo */
  font-family: "Poppins", sans-serif;
  /* Fonte usada para o rótulo */
  font-size: 16px;
...
.form-group input[type="password"] {
  ...
  width: 400px;
  /* Faz o campo ocupar toda a largura do grupo */
  padding: 10px;
  /* Espaço interno do campo */
  border: 1px solid #ccc;
  /* Borda do campo */
  border-radius: 20px;
  /* Bordas arredondadas do campo */
  font-family: "Poppins", sans-serif;
  /* Fonte usada no campo */
  font-size: 16px;
  /* Tamanho da fonte no campo */
  box-sizing: border-box;
  /* Inclui padding e borda no cálculo da largura total */
}
...
.form-group input[type="password"]:focus {
  ...
  /* Sombra ao redor do campo ao ganhar foco */
}
...
.background3 {
  ...
  width: 100%;
  height: 100%;
  /* Ocupa toda a altura da janela de visualização */
...
.access-button {
  ...
  cursor: pointer;
  /* Cursor de ponteiro ao passar o mouse sobre o botão */
  display: inline-flex;
  /* Flexbox para centralizar o link */
...
.button-link {
  color: #ffffff;
  /* Cor do texto do link dentro do botão */
  text-decoration: none;
  /* Remove o sublinhado do link */
  width: 100%;
